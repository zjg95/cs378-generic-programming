...
TEST(CollatzFixture, cycle_length3) {
    ASSERT_EQ(8, collatz_cycle_length(3));
}
...
TEST(CollatzFixture, max_cycle1) {
    ASSERT_EQ(20, collatz_max_cycle(1,10));
}

TEST(CollatzFixture, max_cycle2) {
    ASSERT_EQ(125, collatz_max_cycle(100, 200));
}

TEST(CollatzFixture, max_cycle3) {
    ASSERT_EQ(89, collatz_max_cycle(201, 210));
}
